...
function AnnouncementModal({
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={cn("px-6 py-5 bg-gradient-to-br", priCfg.headerGradient)}
        >
        ...
        <div className="px-6 pb-5 flex flex-wrap items-center gap-3 text-xs text-slate-400 border-t border-slate-100 pt-4">
          ...
          <span className="flex items-center gap-1">
            ...
            {ann.published_at
              ? formatDistanceToNow(new Date(ann.published_at), {
                  addSuffix: true,
                })
...
function AnnouncementCard({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "px-4 py-3 bg-gradient-to-br flex items-center gap-3",
          priCfg.headerGradient,
        )}
      >
...
export default function StudentAnnouncements() {
  ...
  const filtered = announcements.filter((a) => {
    ...
    if (typeFilter !== "all" && (a.ann_type || "general") !== typeFilter)
      return false;
    return true;
  });
