        ...
        <div className="bg-gradient-to-r from-indigo-600 to-violet-600 rounded-2xl p-6 text-white shadow-lg shadow-indigo-200">
          <div className="flex items-center gap-3 mb-1">
            ...
            <div>
              ...
              <p className="text-indigo-200 text-sm">Ask questions, share answers, help your classmates</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-slate-100 p-5 shadow-sm">
          ...
          {loading ? (
            ...
            <div className="rounded-xl border border-dashed border-slate-200 bg-slate-50 p-6 text-center">
              ...
              <p className="text-xs text-slate-400 mt-1">Enroll in a course to access lesson discussions.</p>
            </div>
          ) : (
            <>
              <div className="max-h-48 overflow-y-auto pr-1 flex flex-wrap gap-2 content-start">
                ...
                {filtered.length === 0 && (
                  <p className="text-sm text-slate-400 py-2">No lessons match "{search}"</p>
                )}
              </div>
              {lessons.length > 5 && (
